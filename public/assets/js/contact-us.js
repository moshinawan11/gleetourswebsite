...
function imgFunction() {
    ...
    if (x.matches) {
        document.getElementById("coverDivImg").setAttribute("src", "/public/assets/images/contact-us-header2.jpg");
    }
    else {
        document.getElementById("coverDivImg").setAttribute("src", "/public/assets/images/contact-us-header.jpg");
    }
}