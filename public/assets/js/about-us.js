...
function imgFunction() {
    ...
    if (x.matches) {
        document.getElementById("coverDivImg").setAttribute("src", "/public/assets/images/about-us-header2.avif");
    }
    else {
        document.getElementById("coverDivImg").setAttribute("src", "/public/assets/images/about-us-header.avif");
    }
}